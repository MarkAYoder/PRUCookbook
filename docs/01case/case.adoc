...
and the BeagleBone Black with Robotics Cape. It uses the PRU to extend the real-time hardware of the Bone by adding eight addional servor channels and one addition 
real-time encoder input.
