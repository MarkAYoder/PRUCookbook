...
==== Solution
https://github.com/abhishek-kakkar/BeagleLogic/wiki[BeagleLogic] is a 100Msps, 
...
If you want to be running a newer image, there are instructions on the site for https://github.com/abhishek-kakkar/BeagleLogic/wiki/Build-BeagleLogic[building BeagleLogic from scratch], but they seem a bit dated.  Try these:
