...
<<../03details/detailsl#details_configure_servos, Configuring Pins for Controlling Servos>> 
...
<<sase__register_to_pin_table,Register to pin table>>.

[[sase__register_to_pin_table]]
