...
|10-19|`dmemBuf` holds the data to be sent to PRU1.  Each will be transfered
...
|49   |Clear the interupt so it can go again.
|===
...
|27   |Signal PRU 0
|31   |Receive the data. The arguments are the same as `xout()`,  
