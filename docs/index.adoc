...
. link:08ai/ai.html[Moving to the BeagleBone AI]
  ** [x] Moving from two to four PRUs
  ** [x] Seeing how poins are configured
  ** [x] Configuring pins on the AI via device trees
  ** [x] Using the PRU pins
