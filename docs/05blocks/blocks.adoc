...
.pwm8 PRUs sycned
image::figures/pwm8_prus_sycned.png[pwm8 PRUs sycned]

This isn't much different from the previous examples.

.pwm8.c changes from pwm7.pru0.c 
[cols="1,9"]
|===
|Line|Change
...
|73-77|PRU 1 then waits for PRU 0 to signal it.  Bit 31 of `pass:[__]R31` corresponds
