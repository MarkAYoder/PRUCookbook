...
[NOTE]
====
See <<08ai/ai.html#, Configuring pins on the AI via device trees>> for configuring 
pins on the AI.
====
...
[NOTE]
====
See <<08ai/ai.html#, Configuring pins on the AI via device trees>> for all
the PRU pins on the AI.
====
...
[subs=+quotes]
----
include::code/rgb_python_setup.sh[]
----
...
<<blocks_rgb1>> is the PRU code to drive the RGB LED matrix.   Be sure to run
...
image::figures/rgb_pru.jpg[Display running rgb1.pru0.c on PRU 0]
