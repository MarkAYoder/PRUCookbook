...
one for the BeagleBone AI (AM5729 Debian 10.3 2020-04-06 8GB SD IoT TIDL) and
one for all the other Beagles (AM3358 Debian 10.3 2020-04-06 4GB SD IoT).
...
_resin.io_.  Go to <https://www.balena.io/etcher/> and download the version for your host 
