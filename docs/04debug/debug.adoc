...
|0       |black |P9_1     |P9_1    |P9_1    |ground
|4       |orange|P9_24    |P8_43/ P8_36b   |P8_31a   |tx
|5       |yellow|P9_26    |P8_44   |P8_33a   |rx
|===

[[debug_ftdi_pins]]
.FTDI pins for the FTDI connector
image::figures/FTDIhookup_bb.png[FTDI pins for the FTDI connector]
...
[TIP]
====
Either PRU0 and PRU1 can run this code.  Both have access to the same UART.
====
