...
PRU 1 you can get to and additional 14 pins (if they aren't in use for other things.)
...
`__R30`, but it also shows you can useing the OCP.  You get access to many more
